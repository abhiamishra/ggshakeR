...
plot_pizza <- function(data, type = "", template = "", colour_poss, colour_att, colour_def, player_1, player_2, colour_compare, season, season_player_1, season_player_2, theme = "") {
