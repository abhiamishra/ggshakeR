...
The function allows for plotting both **single** and **comparison** player plots, the usage of which shall be outlined below.
...
For season filter, please look at the data scraped from FBRef and look at the "term" in scouting period. The term there will determine what season you will be filtering for when you put it in the function.
