...
For `calculate_epv()`, __always write the dataType that the data is: opta or statsbomb__. After that, we simply get:

```{r, eval=FALSE}
EPVData <- calculate_epv(plottingData, dataType = "statsbomb")
```
